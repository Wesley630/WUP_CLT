...
The graph is appearing unimodal around where we have 9 samples, but we have a bimodal distribution in the beggining and end of graphs where they are proggresing towards a unimodal distribution.
...
With the 25 samples averaged together the graphs are becoming more unimodal compared to having smaller sample sizes averaged.
